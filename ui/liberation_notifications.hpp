class CfgNotifications
{
    ...
    class lib_secondary_delivery_truck : lib_intel
    {
		description = $STR_NOTIFICATION_DELIVERY_START_TEXT;
    };
    ...
    class lib_secondary_delivery_succeeded : lib_default_notification
    {
	description = $STR_NOTIFICATION_DELIVERY_SUCCEEDED_TEXT;
	color[] = {0,1,0,1};
	sound = "taskSucceeded";
    };
    class lib_secondary_delivery_failed : lib_secondary_fob_destroyed
    {
    	description = $STR_NOTIFICATION_DELIVERY_FAILED_TEXT;
    	color[] = {1,0,0,1};
	sound = "taskFailed";
    };
