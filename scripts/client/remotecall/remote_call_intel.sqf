...
if ( _notiftype == 4 ) then {
	[ "lib_secondary_delivery_truck" ] call BIS_fnc_showNotification;
};

if ( _notiftype == 5 ) then {
	[ "lib_secondary_delivery_succeeded" ] call BIS_fnc_showNotification;
};

if ( _notiftype == 9 ) then {
	[ "lib_secondary_delivery_failed" ] call BIS_fnc_showNotification;
};
