...
heavy_vehicles = [
	...
	["B_MBT_01_arty_F",0,1200,50],
	["B_MBT_01_mlrs_F",0,3000,110]
];
...
air_vehicles = [
	["B_Heli_Light_01_F",0,0,20],
	["B_Heli_Light_01_armed_F",0,75,20],
	["B_Heli_Transport_01_F",0,20,25],
	["B_Heli_Transport_03_F",0,20,30],
	["B_Heli_Attack_01_F",0,300,40],
	["B_Plane_CAS_01_F",0,650,100],
	["B_UAV_01_F",0,0,7],
	["B_UAV_02_F",0,150,25],
	["B_UAV_02_CAS_F",0,200,25]
];
...
support_vehicles = [
	...
	[FOB_box_typename,150,1000,0],
	[FOB_truck_typename,150,1000,0],
	...
	["Box_NATO_AmmoVeh_F",10,200,0],

	//DO NOT EDIT
	["Box_NATO_Wps_F",0,500,0],
	["Box_East_Wps_F",0,800,0]

	
	/*	
	[Arsenal_typename,5,200,0],
	[FOB_box_typename,10,300,0],
	[FOB_truck_typename,10,300,20],
	["C_Offroad_01_repair_F",7,20,5],
	["B_Truck_01_Repair_F",3,50,15],
	["B_Truck_01_fuel_F",3,50,15],
	["B_Truck_01_ammo_F",3,50,15],
	["B_Slingload_01_Repair_F",3,5,0],
	["B_Slingload_01_Fuel_F",3,5,0],
	["B_Slingload_01_Ammo_F",3,5,0],
	["B_Slingload_01_Medevac_F",1,5,0],
	["Box_NATO_Wps_F",0,200,0],
	["Box_East_Wps_F",0,375,0],
	["Box_NATO_AmmoVeh_F",0,200,0],
	["Land_Device_assembled_F", 0,1000,0]
	*/
];
if ( isNil "support_vehicles_extension" ) then { support_vehicles_extension = [] };
if ( isNil "_overwrite" ) then { support_vehicles_overwrite = false };
...
ai_resupply_sources = [] + ai_resupply_sources_extension + [ huron_typename, Arsenal_typename, "B_Slingload_01_Ammo_F", "B_APC_Tracked_01_CRV_F", "B_Truck_01_ammo_F", "JNS_Skycrane_Pod_Ammo_BLU_Black" ];
...
opfor_squad_12_standard = [opfor_squad_leader,opfor_team_leader,opfor_machinegunner,opfor_heavygunner,opfor_medic,opfor_marksman,opfor_grenadier,opfor_rpg,opfor_sentry,opfor_sentry,opfor_sentry,opfor_sentry];
...
boats_names = [ "B_Boat_Transport_01_F", "B_Boat_Armed_01_minigun_F", "rhsusf_mkvsoc" ];
...
GRLIB_intel_file = "Land_MultiScreenComputer_01_sand_F";
GRLIB_intel_laptop = "Land_Laptop_03_sand_F";
